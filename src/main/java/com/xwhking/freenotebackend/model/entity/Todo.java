...
public class Todo implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTodoProfile() == null ? other.getTodoProfile() == null : this.getTodoProfile().equals(other.getTodoProfile()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTodoProfile() == null) ? 0 : getTodoProfile().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", todoProfile=").append(todoProfile);
        sb.append(", ifFinish=").append(isFinish);
