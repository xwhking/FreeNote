...
public class TabTask implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        TabTask other = (TabTask) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getTabId() == null ? other.getTabId() == null : this.getTabId().equals(other.getTabId()))
            && (this.getTitle() == null ? other.getTitle() == null : this.getTitle().equals(other.getTitle()))
            && (this.getTabProfile() == null ? other.getTabProfile() == null : this.getTabProfile().equals(other.getTabProfile()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTabProfile() == null) ? 0 : getTabProfile().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", tabProfile=").append(tabProfile);
